...
export const agentsFontSizeBody0 = registerSize('agents.fontSize.body0', '14px');
...
export const agentsSizeSashWidth = registerSize('agents.size.sash.width', '8px');
export const agentsSizeAuxiliaryTabHeight = registerSize('agents.size.auxiliary.tabHeight', '26px');
export const agentsSizeConversationWidth = registerSize('agents.size.conversation.width', `${conversationWidthPx}px`);
export const agentsSizeMessageAvatar = registerSize('agents.size.message.avatar', '28px');
...
export const agentsSizeSettingsContentMax = registerSize('agents.size.settings.contentMax', '960px');
export const agentsSizeSettingsPageMax = registerSize('agents.size.settings.pageMax', '720px');
export const agentsSizeSettingsProvidersRail = registerSize('agents.size.settings.providersRail', '168px');
export const agentsSizeSettingsCopyMax = registerSize('agents.size.settings.copyMax', '1120px');
export const agentsSizeToggleWidth = registerSize('agents.size.toggle.width', '38px');
export const agentsSizeToggleHeight = registerSize('agents.size.toggle.height', '22px');
export const agentsSizeToggleKnob = registerSize('agents.size.toggle.knob', '18px');
